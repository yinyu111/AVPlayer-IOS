...
- (instancetype)initWithConfig:(VideoEncoderConfig *)config {
    ...
    if (self) {
        _config = config;
        _encoderQueue = dispatch_queue_create("com.kaku.videoEncoder", DISPATCH_QUEUE_SERIAL);
...
- (void)encodePixelBuffer:(CMSampleBufferRef)sampleBuffer ptsTime:(CMTime)timeStamp {
