...
@property (nonatomic, assign) AudioConverterRef audioDecoderInstance;
@property (nonatomic, assign) CMFormatDescriptionRef pcmFormat;
...
- (instancetype)init {
    self = [super init];
    if (self) {
        _decodeQueue = dispatch_queue_create("com.kaku.audioDecoder", DISPATCH_QUEUE_SERIAL);
    }
