...
@property (nonatomic, assign, readwrite) NSInteger audioChannels;
@property (nonatomic, assign, readwrite) NSInteger bitDepth;
...
- (instancetype)initWithChannels:(NSInteger)channels bitDepth:(NSInteger)bitDepth sampleRate:(NSInteger)sampleRate {
    ...
    if (self) {
        ...
        _renderQueue = dispatch_queue_create("com.kaku.audioRender", DISPATCH_QUEUE_SERIAL);
    }
