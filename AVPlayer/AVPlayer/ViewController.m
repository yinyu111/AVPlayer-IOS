...
- (void)viewDidLoad {
    ...
    self.demoList = @[@"Audio Capture", @"Audio Demuxer", @"Audio Render", @"Video Capture"];
    self.demoPageNameList = @[@"AudioCaptureViewController", @"AudioDemuxerViewController", @"AudioRenderViewController",  @"VideoCaptureViewController"];
