...
- (void)viewDidLoad {
    ...
    self.demoList = @[@"Audio Capture", @"Audio Demuxer", @"Audio Render", @"Video Encoder", @"Video Muxer", @"Video Demuxer", @"Video Remuxer", @"Video Decoder", @"Video Render"];
    self.demoPageNameList = @[@"AudioCaptureViewController", @"AudioDemuxerViewController", @"AudioRenderViewController", @"VideoEncoderViewController", @"VideoMuxerViewController", @"VideoDemuxerViewController", @"VideoRemuxerViewController", @"VideoDecoderViewController", @"VideoRenderViewController"];
